...
const FontPicker = () => {
  ...
  return (
    <SubPopup anchor={fontPickerPos} onClose={() => setFontPickerPos(null)} direction="top" padding={0} variant="glass" glassPad={['1', '4']} closeOnOutside={false} className="magic-hover" popupRef={ref}>
      {Indicator}
