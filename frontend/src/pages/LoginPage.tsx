...
function SocialLoginButtons() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
      <a href={`${API_URL}/api/auth/google`} className="social-btn">
      ...
      <a href={`${API_URL}/api/auth/github`} className="social-btn">
      ...
      <a href={`${API_URL}/api/auth/microsoft`} className="social-btn">
